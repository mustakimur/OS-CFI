...
llvm::BasicBlock *CodeGenFunction::EmitLandingPad() {
  ...
  EmitStoreToMetadata(LPadExn, getExceptionSlot());
  llvm::Value *LPadSel = Builder.CreateExtractValue(LPadInst, 1);
  EmitStoreToMetadata(LPadSel, getEHSelectorSlot());
...
static void emitWasmCatchPadBlock(CodeGenFunction &CGF,
  ...
  CGF.EmitStoreToMetadata(Exn, CGF.getExceptionSlot());
  ...
  struct PerformFinally final : EHScopeStack::Cleanup {
    ...
    void Emit(CodeGenFunction &CGF, Flags flags) override {
      ...
      if (CGF.HaveInsertPoint()) {
        ...
        CGF.EmitStoreToMetadata(SavedCleanupDest,
...
CodeGenFunction::GenerateSEHFilterFunction(CodeGenFunction &ParentCGF,
  ...
  EmitStoreToMetadata(R, ReturnValue);
...
void CodeGenFunction::EmitSEHExceptionCodeSave(CodeGenFunction &ParentCGF,
  ...
  EmitStoreToMetadata(Code, SEHCodeSlotStack.back());
}
